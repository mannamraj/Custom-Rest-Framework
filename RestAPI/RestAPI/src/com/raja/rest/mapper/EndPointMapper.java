...
public class EndPointMapper implements Mapper<Map<String,List<ControllerDetails>>, List<Class<?>>> {
	
	public static EndPointMapper build(){
		
		return new EndPointMapper();
	}

	@Override
	public Map<String,List<ControllerDetails>> map(List<Class<?>> loader) {
		
        List<Class<?>> classList =  loader;
            ...
            if(annotation != null ) {
                ...
                for (Method method:methods) {
                    ...
                    if(restServiceMapper != null){
                        ...
                        controllerDetails.setContentType(restServiceMapper.contentType());
    		...
    		classList =  new ArrayList<Class<?>>();
    		 ...
    		 final ClassLoader loader = Thread.currentThread().getContextClassLoader();
    	        try {
    	           ...
    	           throw new FramerWorkException(e);
    	        }
